<template>
  <div class="">
      ...
      <div class=" py-10 md:py-40 px-6 md:px-2">
         <h1 class="text-secondary-500 lg:px-28 font-bold text-lg text-center mb-4 lg:mb-16 lg:text-4xl">OUR TOUR EVENTS</h1>
...
data(){
  ...
  methods:{
   ...
   closeTourEventModal(){
    this.event_tour_modal=!this.event_tour_modal
   }
