<template>
    <div class="bg-no-repeat bg-cover mb-2 lg:mb-0 bg-top rounded-xl cursor-pointer" :style="{ backgroundRepeat: 'no-repeat' + ';', backgroundImage: 'url(' + tour_event.picture + ')' } ">
        <div class="relative z-0 py-44 hover:bg-black hover:bg-opacity-25 transition duration-500 ease-in-out bg-gradient-to-b from-transparent to-gray-900 rounded-xl">
